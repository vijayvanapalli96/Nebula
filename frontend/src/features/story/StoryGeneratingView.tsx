...
const GlowSpinner: React.FC = () => (
  <div className="relative w-24 h-24 flex-shrink-0">
    ...
    <motion.div
      ...
      style={{ border: '2px solid transparent', borderBottomColor: '#60a5fa', borderLeftColor: 'rgba(96,165,250,0.3)' }}
      animate={{ rotate: -360 }}
...
const StoryGeneratingView: React.FC<StoryGeneratingViewProps> = ({ error, onRetry }) => {
...
export default StoryGeneratingView;
